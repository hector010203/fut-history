            ...
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Bournemouth_Crest_Comp_180x1801550138851194.png" alt="Escudo de Bournemouth">' +
                '</div>' +
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Arsenal_Crest_Comp_180x1801549549037942.png" alt="Escudo de Arsenal">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                    '<img src="assets/premier/Chelsea_Crest_Comp_180x1801550141382168.png" alt="imagen">' +
                    '<img src="assets/premier/Manchester_United_Crest_Comp_180x1801550591475296.png" alt="imagen">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Crystal_Palace_Crest_Comp_180x1801659968262919.png" alt="Escudo de Crystal Palace">' +
                '</div>' +
                '<div class="contenido-modal">' +
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Everton_Crest_Comp_180x1801550158812653.png" alt="Escudo de Everton">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                    '<img src="assets/premier/Liverpool_Crest_Comp_180x1801550570408320.png" alt="imagen">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Fulham_Crest_Comp_180x1801550567888147.png" alt="Escudo de Fulham">' +
                '</div>' +
                '<div class="contenido-modal">' +
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Leicester_City_Crest_Comp_180x1801550570305056.png" alt="Escudo de Leicester">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                      '<img src="assets/premier/Nottingham_Forest_Crest_Comp_180x1801658493274417.png" alt="imagen">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Liverpool_Crest_Comp_180x1801550570408320.png" alt="Escudo de Liverpool">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                      '<img src="assets/premier/Everton_Crest_Comp_180x1801550158812653.png" alt="imagen">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Manchester_City1505486069132.png" alt="Escudo de Manchester City">' +
                '</div>' +
                '<div class="contenido-modal">' +
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Manchester_United_Crest_Comp_180x1801550591475296.png" alt="Escudo de Manchester United">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                      '<img src="assets/premier/Manchester_City1505486069132.png" alt="imagen">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Newcastle_United_Crest_Comp_180x1801550136308485.png" alt="Escudo de Newcastle">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                      '<img src="assets/premier/sunderland.png" alt="Imagen de los rivales de Newcastle">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Tottenham_Hotspur_Crest_Comp_180x1801550155045146.png" alt="Escudo de Tottenham">' +
                '</div>' +
                '<div class="contenido-modal">' +
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Nottingham_Forest_Crest_Comp_180x1801658493274417.png" alt="Escudo de Nothinham Forest">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                      '<img src="assets/premier/derby-count.png" alt="Imagen de los rivales de Nothinham Forest">' +
                      '<img src="assets/premier/Leicester_City_Crest_Comp_180x1801550570305056.png" alt="imagen">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Southampton_Crest_Comp_180x1801550143313525.png" alt="Escudo de Southampton">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                      '<img src="assets/premier/portsmoputh.png" alt="Imagen de los rivales de Southampton">' +
                      '<img src="assets/premier/Bournemouth_Crest_Comp_180x1801550138851194.png" alt="imagen">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/West_Ham_United_Crest_Comp_180x1801550155546987.png" alt="Escudo de West Ham">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                      '<img src="assets/premier/Tottenham_Hotspur_Crest_Comp_180x1801550155045146.png" alt="imagen">' +
                      '<img src="assets/premier/Chelsea_Crest_Comp_180x1801550141382168.png" alt="imagen"' +
                      '<img src="assets/premier/millwall.png" alt="Imagen de los rivales de West Ham">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
    ...
    Swal.fire({
        html: 
            '<div class="contenedor-modal">' +
              '<div class="my-alert">' +
                '<div class="image-container">' +
                    '<img src="assets/premier/Wolverhampton_Wanderers_Crest_Comp_180x1801550155723606.png" alt="Escudo de Wolverhampton">' +
                '</div>' +
                '<div class="contenido-modal">' +
              ...
              '<div class="my-alert-2">' +
                '<div class="contenido-modal">' +
                  ...
                  '<div class="image-container-rivales">' +
                      '<img src="assets/premier/albion.png" alt="Imagen de los rivales de Wolverhampton">' +
                      '<img src="assets/premier/Aston_Villa_Crest_Comp_180x1801549971248164.png" alt="imagen">' +
                  '</div>' +
                '</div>' +
              '</div>' +
            '</div>',
